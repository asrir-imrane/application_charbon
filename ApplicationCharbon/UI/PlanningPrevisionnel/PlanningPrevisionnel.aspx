                        ...
                        <div class="table-responsive">
                            <div class="d-flex justify-content-between align-items-center form-group">
                                <div class="d-flex align-items-center">
                                    <div>
                                        <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#ajouterPV">
                                    ...
                                    <div class="ms-3 search-form">
                                        <form class="d-flex">
                                            <input class="form-control  me-2" type="search" placeholder="Rechercher par nom ..." aria-label="Search" />
                                        </form>
                                    </div>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h4 class="modal-title">Ajouter Planning Previsionnel</h4>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="file" name="excel-file" id="excelFile" />
                                        </div>

                                    </div>
                                    <div class="modal-footer">
                                        <asp:Button type="submit" Text="Ajouter le planning previsionnel" class="btn btn-success" OnClick="AddButton_PV_Click" runat="server"></asp:Button>
